...
MEDIA_ROOT = '/sites/video1/user_upload/media/'
...
STATIC_ROOT = '/sites/video1/static'
...
STATICFILES_DIRS = (
    ...
    '/home/gk/Django/HackedExistence-Tutorial/static/',
)
...
SECRET_KEY = 'yw2(nm#4s=a@-87)xj)k0@11m@l%kup*eju70^om@@v*9t*1yd'
